...
/*
		...
		while(count < 10){
			...
			String clickXpath = ".//*[@id='stats_table']/table/tbody/tr["+row+"]/td[12]";
		  		...
		  		if(country.contains("US")){
		  			...
		  			countryAndCode.add("France");
			  			...
			  			countryAndCode.add("United Kingdom");
				  			...
				  			countryAndCode.add("RU");
				  			countryAndCode.add("Russian Federation");
				  		}
					  		else{	    		
	...
	public void pixelTestTool(WebDriver o_driver, String pixelType, String country){
		...
		if(baseURL.contains("mm-tracking")){
	...
	public void changeProxy(WebDriver driver, String testCountry){
	  
		driver.switchTo().frame("geoedgecentraltoolbar-iframe");
		waitForElementByID(20, "geoedgecentraltoolbar_form");
		driver.findElement(By.xpath(".//*[@id='geoedgecentraltoolbar_form']/select")).click();
		 		 
		Select drpCountry = new Select(driver.findElement(By.xpath(".//*[@id='geoedgecentraltoolbar_form']/select")));
		 
		drpCountry.selectByVisibleText(testCountry);
	
	}
	
	public void disconnectProxy(WebDriver driver2){
		
		boolean disconnect=false;
		while(!disconnect){
			try{
				 //click Disconnect button
				 waitForElementByXpath(20, ".//*[@id='buttons']/input");
				 driver2.findElement(By.xpath(".//*[@id='buttons']/input")).click();
				 
				 //Wait disconnected then close all browser.
				 waitForElementByXpath(20, ".//*[@id='middle-content']/p/span/span");
